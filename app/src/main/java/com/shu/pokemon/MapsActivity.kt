            ...
            while (true){
                ...
                try {
                    ...
                    runOnUiThread {
                        ...
                        // show me
                        val india = LatLng(location!!.latitude, location!!.longitude)
                        mMap!!.addMarker(MarkerOptions()
                            .position(india)
                            .title("Me")
                            .snippet(" here is my location")
                            .icon(BitmapDescriptorFactory.fromResource(R.drawable.mario)))
                        mMap!!.moveCamera(CameraUpdateFactory.newLatLngZoom(india,7f))
                        ...
                        for(i in 0..listPockemons.size-1){
                            ...
                            if(newPockemon.IsCatch==false){
                                ...
                                if (location!!.distanceTo(newPockemon.location)<3){
    ...
    fun  LoadPockemon() {
        ...
        listPockemons.add(
            Pockemon(
                ...
                "Charmander", "Charmander lives in Nepal", 55.0, 20.7500, 78.6000
            )
        )
        listPockemons.add(
            Pockemon(
                R.drawable.bulbasaur,
                "Bulbasaur", "Bulbasaur lives in USA", 90.5, 23.168770, 79.931847
            )
        )
        listPockemons.add(
            Pockemon(
                R.drawable.squirtle,
                "Squirtle", "Squirtle lives in Iraq", 33.5,22.0700 ,78.9300
            )
        )
    }
